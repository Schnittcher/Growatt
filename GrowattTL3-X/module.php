...
require_once __DIR__ . '/../libs/GrowattModBus.php';
    ...
    class GrowattTL3X extends GrowattModBus
    {
        ...
        public static $Variables = [
            ...
            ['Phase 1 Grid Output Current', VARIABLETYPE_FLOAT, '~Electricity', 0.1,  0x0027, 4, 1,  null, true],
            ['Phase 2 Grid Voltage', VARIABLETYPE_FLOAT, '~Volt', 0.1,  0x002A, 4, 1,  null, true],
            ['Phase 2 Grid Output Current', VARIABLETYPE_FLOAT, '~Electricity', 0.1,  0x002B, 4, 1,  null, true],
            ['Phase 3 Grid Voltage', VARIABLETYPE_FLOAT, '~Volt', 0.1,  0x002E, 4, 1,  null, true],
            ['Phase 3 Grid Output Current', VARIABLETYPE_FLOAT, '~Electricity', 0.1,  0x002F, 4, 1,  null, true],
